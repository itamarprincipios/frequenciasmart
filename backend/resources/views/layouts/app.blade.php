...
<head>
    ...
    <title>EduTrack – @yield('titulo', 'Sistema de Frequência')</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-item { display: flex; align-items: center; gap: .75rem; padding: .7rem 1.5rem;
                    color: #c7d2fe; text-decoration: none; font-size: .875rem; transition: all .2s; border-radius: 0; }
        ...
        /* FORM LOGOUT */
        .logout-btn { background: none; border: none; cursor: pointer; color: #ef4444; font-size: .8rem; }
...
<body x-data="{ sidebarOpen: false }">
    ...
    <aside class="sidebar" :class="{ 'open': sidebarOpen }">
        ...
        <nav>
            @php $role = session('usuario.role') ?? ''; @endphp

            @if(in_array($role, ['DIRETOR','VICE']))
            ...
            <a href="/orientadora" class="nav-item {{ request()->is('orientadora') ? 'active' : '' }}">
            ...
            <a href="/frequencia/lancar" class="nav-item {{ request()->is('frequencia/lancar') ? 'active' : '' }}">
            ...
            <a href="/frequencias" class="nav-item {{ request()->is('frequencias') ? 'active' : '' }}">
            ...
            <a href="/alunos" class="nav-item {{ request()->is('alunos*') ? 'active' : '' }}">
            ...
            @if(in_array($role, ['DIRETOR','VICE']))
            <a href="/turmas" class="nav-item {{ request()->is('turmas') ? 'active' : '' }}">
        ...
        <div class="sidebar-footer">
            ...
            <span style="margin-top:.2rem">
                <span class="badge badge-blue">{{ session('usuario.role', '') }}</span>
            </span>
