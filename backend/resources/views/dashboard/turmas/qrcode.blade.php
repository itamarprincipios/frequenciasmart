...
<head>
    ...
    <title>QR Code – {{ $turma->nome }}</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .turma-nome { font-size:1.2rem; font-weight:700; color:#1e293b; margin-top:1.25rem; }
        .turma-info { font-size:.85rem; color:#64748b; margin-top:.25rem; }
        .turno-tag  {
...
<div class="actions">
    ...
    <a class="btn btn-back" href="/turmas">← Voltar para turmas</a>
</div>
...
<div class="container">
    <div class="qr-card">
        ...
        <div class="turma-info">Ano Letivo: {{ $turma->ano_letivo }}</div>
        ...
        <div class="token-label">Token: {{ $turma->qr_token }}</div>
    </div>
</div>
