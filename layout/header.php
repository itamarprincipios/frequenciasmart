...
<aside class="sidebar" id="sidebar">
    ...
    <nav onclick="if(window.innerWidth <= 768) toggleMenu()">
        ...
        <?php else: ?>
            ...
            <a href="/totem" class="nav-item <?= rota_ativa('totem') ?>">
            ...
            <a href="/justificativas" class="nav-item <?= rota_ativa('justificativas*') ?>">
            ...
            <a href="/ocorrencias" class="nav-item <?= rota_ativa('ocorrencias*') ?>">
